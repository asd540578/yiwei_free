...
public class XiaNa_Change_Reel extends ItemExecutor {
	...
	private void usePolyPotion(final L1PcInstance pc, final int itemId) {
		...
		int polyId = 0;
		if ((itemId == 49149) && (pc.get_sex() == 0) && pc.isCrown()) { // 根据职业与性别变身成不同形态(等級30)
			polyId = 6822;
			...
			polyId = 7142;
		} else if ((itemId == 49150) && (pc.get_sex() == 0) && pc.isCrown()) { // 根据职业与性别变身成不同形态(等級40)
			polyId = 6832;
			...
			polyId = 7146;
		} else if ((itemId == 49151) && (pc.get_sex() == 0) && pc.isCrown()) { // 根据职业与性别变身成不同形态(等級52)
			polyId = 6842;
			...
			polyId = 7150;
		} else if ((itemId == 49152) && (pc.get_sex() == 0) && pc.isCrown()) { // 根据职业与性别变身成不同形态(等級55)
			polyId = 6852;
			...
			polyId = 7154;
		} else if ((itemId == 49153) && (pc.get_sex() == 0) && pc.isCrown()) { // 根据职业与性别变身成不同形态(等級60)
			polyId = 6862;
			...
			polyId = 7158;
		} else if ((itemId == 49154) && (pc.get_sex() == 0) && pc.isCrown()) { // 根据职业与性别变身成不同形态(等級65)
			polyId = 6872;
			...
			polyId = 7162;
		} else if ((itemId == 49155) && (pc.get_sex() == 0) && pc.isCrown()) { // 根据职业与性别变身成不同形态(等級70)
			polyId = 6882;
