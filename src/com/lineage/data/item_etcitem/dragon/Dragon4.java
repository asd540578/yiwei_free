...
public class Dragon4 extends ItemExecutor {
	...
	private final int[] _items1 = new int[]{
			40341,// 安塔瑞斯之鱗
			40342,// 安塔瑞斯之爪
			40343,// 安塔瑞斯之眼
			40344,// 安塔瑞斯之血
	...
	private final int[] _items2 = new int[]{
			40349,// 巴拉卡斯之鱗
			40350,// 巴拉卡斯之爪
			40351,// 巴拉卡斯之眼
			40352,// 巴拉卡斯之肉
	...
	private final int[] _items3 = new int[]{
			40357,// 法利昂之鱗
			40358,// 法利昂之爪
			40359,// 法利昂之眼
			40360,// 法利昂之肉
	...
	private final int[] _items4 = new int[]{
			40365,// 林德拜爾之鱗
			40366,// 林德拜爾之爪
			40367,// 林德拜爾之眼
			40368,// 林德拜爾之血
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		case 40348:// 安塔瑞斯之牙
			if (allItem(pc)) {
				delAll(pc, null, 49500);// 龍 結晶
				return;
				
			} else {
				if (allItem(pc, _items1)) {
					delAll(pc, _items1, 49504);// 地屬性 結晶
					return;
				}
			}
			break;
		...
		case 40356:// 巴拉卡斯之牙
			if (allItem(pc)) {
				...
				if (allItem(pc, _items2)) {
					delAll(pc, _items2, 49501);// 火屬性 結晶
					return;
				}
			}
			break;
		...
		case 40364:// 法利昂之牙
			if (allItem(pc)) {
				...
				if (allItem(pc, _items3)) {
					delAll(pc, _items3, 49502);// 水屬性 結晶
					return;
				}
			}
			break;
		...
		case 40372:// 林德拜爾之牙
			if (allItem(pc)) {
				...
				if (allItem(pc, _items4)) {
					delAll(pc, _items4, 49503);// 風屬性 結晶
					return;
				}
			}
			break;
