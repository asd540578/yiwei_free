...
public class ULong32 {
	 ...
	 */
	public static long fromArray(final char[] buff) {
	 ...
	 * @return long unsigned long value stored as a long
	 */
	public static long fromArray(final byte[] buff) {
		return fromLong64(((buff[3] & 0xFF) << 24) | ((buff[2] & 0xFF) << 16)
				| ((buff[1] & 0xFF) << 8) | (buff[0] & 0xFF));
	}
	 ...
	 * @return long unsigned long value stored as a long
	 */
	public static long fromLong64(final long l) {
	 ...
	 * @return long unsigned long value stored as a long
	 */
	public static long fromInt32(final int i) {
	 ...
	 * @return long unsigned long value stored as a long
	 */
	public static long sub(final long l1, final long l2) {
		return fromInt32((int) l1 - (int) l2);
	}
}
