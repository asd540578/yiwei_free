...
public class S_AddSkill extends ServerBasePacket {
	...
	public S_AddSkill(L1PcInstance pc, int[] skills) {
		...
		this.writeC(skills[22]);// 龍騎士技能 1
		this.writeC(skills[23]);// 龍騎士技能 2
		this.writeC(skills[24]);// 龍騎士技能 3
		
		this.writeC(skills[25]);// 幻術師 1
		this.writeC(skills[26]);// 幻術師 2
		this.writeC(skills[27]);// 幻術師 3
	...
	public S_AddSkill(final L1PcInstance pc, 
			...
			final int k1, final int k2, final int k3, 
