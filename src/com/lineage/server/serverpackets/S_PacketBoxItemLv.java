...
public class S_PacketBoxItemLv extends ServerBasePacket {
	...
	/**
	 * writeByte(level) writeByte(0): <font color=#00800>(672) 等級%d(51~127)以上才可使用此道具。 </font><br>
	 * writeByte(0) writeByte(level): <font color=#00800>(673) 等級%d(0~49)以下才能使用此道具。 </font>
	 */
	public static final int MSG_LEVEL_OVER = 0x0c;//12;

	/**
	 * <b><font color=red>封包分類項目 : </font><font color=#008000>封包盒子(物品等級限制)</font></b>
	 * @param minLv
	 * @param maxLv
	 */
	...
	/**
	 * <b><font color=red>封包分類項目 : </font><font color=#008000>封包盒子(測試物品等級限制)</font></b>
	 * @param minLv
	 */
