...
public class LogChatTable implements LogChatStorage {
	 ...
	 */
	@Override
	public void isTarget(final L1PcInstance pc, final L1PcInstance target, final String content, final int type) {
		if (target == null) {
			return;
		}
		Connection con = null;
	 ...
	 */
	@Override
	public void noTarget(final L1PcInstance pc, final String content, final int type) {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			final String account_name = pc.getAccountName();
