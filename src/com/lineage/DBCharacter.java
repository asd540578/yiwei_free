...
public class DBCharacter implements Database {

	private static final Log _log = LogFactory.getLog(DBCharacter.class);
	private static DBCharacter _instance;
	private ComboPooledDataSource _source;
	private String _database;

	public static DBCharacter get() {
		return _instance;
	}
